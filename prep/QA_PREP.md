...
not being wrong, it is four people looking at each other for three seconds.

---

## Tier 1 — the questions you will definitely get

### "The stock has already tripled. Why buy now?"
...
**Have ready:** the June-quarter realised price of US$2,107/t versus the FY26 average of US$1,488/t.

### "Your target is above consensus. What do you know that the street doesn't?"

> Nothing about the lithium price, deliberately. Our FY27 assumption of US$1,700/t is 11% below
> spot-implied realisation and below the Australian Government's own 2026 forecast of US$2,236/t.
> Where we differ is the operating position: a cost base falling for structural reasons, a growth
> option with A$175m of pre-FID capital already committed, and a downstream route that becomes
...
Agree with them. It is on the slide.

> Yes, and we say so on slide 9 and again in appendix D4. PLS would have bought that sorter without
> an ESG rationale. Under Porter and Kramer that still qualifies as level two, redefining
> productivity, but level two is not a differentiator because any competitor can buy a sorter. That
> is exactly why our level-one argument rests on the mid-stream plant and the Korean joint venture
> instead, and why we quantify ore sorting at A$30/t rather than dressing it up as a moat.

### "Are you double-counting? Those cost savings are already in your cash flows."

This is the sharpest question available and the slide answers it in red.

> No, and the sheet says so at the top: this is an attribution, not an addition. The ore-sorting and
...
> have. Scope 1 and 2 abatement on iron ore is a cost of staying in business, not a new pool of
> value. Rio has genuine lithium exposure but bought it at the top of the cycle for US$6.7bn with
> US$14.1bn of net debt, so a lithium thesis expressed through Rio is mostly an iron ore position.
> PLS is the only one of the six where the environmental outcome is the reason the customer exists.

**If pushed on South32:** it was our runner-up, and we say so in appendix C6.

---

## Tier 2 — the technical questions

### "Does your 16-year mine life use pre- or post-P2000 throughput?"

> Post. We divide the remaining ore base by the FY36 mining rate of 14.3Mt a year, which already
> includes P2000 at full run rate. Doubling throughput halves the life and the model captures that
> directly, which is why the bull case has a *shorter* life at 14.2 years and gives back part of the
> volume upside in the terminal value.

### "Where does the 75% resource-to-reserve conversion come from?"

Concede immediately that it is a judgement.

> It is our assumption and it is the single most important one on the page, which is why it is
> highlighted yellow in the workbook. The reserve alone, 214Mt last stated in August 2023, would not
> support the expansion we model. At 60% conversion the target falls about A$0.40; at 90% it rises
> about A$0.30. The reserve has not been restated since the June 2025 resource upgrade, so the next
> reserve statement moves it in either direction.
...
### "How did you get A$30/t for ore sorting and A$18/t for power?"

> FY26 unit costs fell A$58/t while volumes rose 17%. We attribute roughly half to fixed-cost
> dilution and half, about A$29/t, to sorting. For power we take 15–20% of the A$569/t cost base as
> power, call it A$95/t, and assume a diesel-to-gas-and-solar switch cuts about a fifth of it. Both
> are our estimates with the arithmetic on the slide. PLS does not disclose either.

### "What is your WACC and why?"
...
## Tier 3 — questions aimed at the gaps we disclosed

**Every one of these is in appendix F4. If a judge finds one you did not disclose, that is a
failure. If they find one you did disclose, it is evidence you did the work.**
...
## Tier 4 — the ones designed to unsettle you

### "Your own recommendation contributes to the oversupply you are worried about."

True, and it is on slide B6.

> Correct. PLS restarted Ngungaju in the same window as Bald Hill and Finniss and is guiding to a
> 17–25% volume increase. Everyone restarting at once is what caps a price recovery. That is why our
> base case assumes prices fall about a fifth from the June-quarter exit rate, and why the cost curve
> matters more than the price forecast: the question is not who supplies the next tonne, it is who is
> still profitable when they all do.

### "You claim social licence protects P2000, then say the offsets scheme is inadequate. Which is it?"

Both. Do not flinch.

> Both, and they are different approvals with different failure modes. Heritage approval turns on
> relationships with Traditional Owners and on process. Environmental offsets turn on a state
> scheme's pricing, which an independent review found too low at A$893 to A$3,781 a hectare. PLS can
> be strong on the first and exposed on the second at the same time. It is why schedule protection is
> the *smallest* item in our bridge at A$0.13, and why the offsets problem is an engagement ask
> rather than a valuation adjustment.
...
### "Sodium-ion makes lithium worthless. Discuss."

> It is the sharpest substitution risk and we rate it that way in appendix B11. It is most credible
> in stationary storage, which is exactly the demand leg we lean on. Solid-state is usually
> mischaracterised as a lithium threat and is more likely lithium-positive per kWh. Our terminal
> value is a finite annuity rather than a perpetuity, so roughly half our enterprise value sits in a
> window where this risk is live. We would watch sodium-ion cell cost per kWh and announced storage
> orders.
