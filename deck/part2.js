...
module.exports = function (pres, ctx) {
  ...
  // ---------------------------------------------------------------- 3. COMPANY OVERVIEW
  {
    ...
    s.addNotes("S3 | 18s | SPEAKER B | do NOT read the four statistics\n\n\"One line on the year. Record volumes, a 59% margin, and unit costs DOWN 9% while volumes rose 17%. Costs falling while volumes rise, through the worst lithium downturn in a decade. That's the operating position we're underwriting.\"\n\nLAND: costs down 9%, volumes up 17%, same year.");
  ...
  // ---------------------------------------------------------------- 4. THE CYCLE
  {
    ...
    s.addNotes("S4 | 25s | SPEAKER B | the credibility slide. Judges expect a lithium bull to wave the price away\n\n\"Prices tripled off the 2025 trough, then fell two hundred and seventy dollars a tonne in a single week in August as Bald Hill, Finniss and Jianxiawo restarted. We're not going to pretend that didn't happen. Wood Mackenzie still calls surplus into the early 2030s, and we carry their view as our bear case.\"\n\nLAND: we carry the bear's view, not our own.  CUT IF BEHIND: the three mine names.");
  ...
  {
    const s = pres.addSlide(); bg(s); nav(s, "Industry");
    s.addNotes("S5 | 22s | SPEAKER B\n\n\"Every team here will tell you lithium demand grows with electric vehicles. That argument rests on one policy variable and that variable just turned hostile. Ours doesn't need it. Storage installations grew about 51% last year, and storage is not subsidy-driven. The demand leg holds without a single EV assumption.\"\n\nLAND: our demand case survives the subsidy repeal.");
  ...
  {
    const s = pres.addSlide(); bg(s); nav(s, "Industry");
    s.addNotes("S6 | 35s | SPEAKER B | slow down, this is the mechanism that makes the bear case survivable\n\n\"Here's why we can be relaxed about the price. Our bear case assumes a realised price of about eleven hundred and forty-five US dollars a tonne. At that price the top quartile of world supply is under water and Pilgangoora is still generating cash margin.\"\n\n\"That's what swing supply means in practice. The tonnes that come off are somebody else's. PLS doesn't just survive a downturn, it buys assets during one. It bought Latin Resources in scrip at the trough and restarted Ngungaju when prices recovered.\"\n\nLAND: at our bear price a quarter of world supply loses money and PLS doesn't.  CUT: Latin Resources.\nHANDOVER: \"That's the asset. Here's the argument.\"");
